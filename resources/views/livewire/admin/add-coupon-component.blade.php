								...
								<div class="card-body row">
									<div class="col-lg-12 col-md-12 col-sm-12 p-t-20">
										<div
											...
											<input class="mdl-textfield__input form-control " type="text" id="txtVno">
										</div>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
										<label for="vtype" class="mdl-textfield__label">Percentage or Flat</label>
											<input class="mdl-textfield__input form-control" type="text" id="vtype" value=""  tabIndex="-1">
										</div>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<label class="mdl-textfield__label" for="txtSCapacity">Enter Amount/Percent</label>
											<input class="mdl-textfield__input form-control" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="txtSCapacity">
										</div>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 p-t-20">
										<div
											...
											<input class="mdl-textfield__input form-control" type="text" id="date1">
										</div>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 p-t-20">
										<div
											...
											<input class="mdl-textfield__input form-control" type="text" id="txtvmodel">
										</div>
									</div>
