<div class="page-content-wrapper">
				<div class="page-content">
					...
					<ul class="nav nav-pills nav-pills-rose">
						<li class="nav-item tab-all"><a class="nav-link active show" href="#tab1"
								data-bs-toggle="tab">List View</a></li>
												...
												<table class="table table-hover table-checkable order-column full-width"
													...
													<tbody>
														<tr class="odd gradeX">
															...
															<td>
																<span
																	class="label label-sm box-shadow-1 label-success">On
																	Trip</span>
															</td>
															<td class="center">
														...
														<tr class="odd gradeX">
															...
															<td>
																<span
																	class="label label-sm box-shadow-1 label-warning">Available
																</span>
															</td>
															<td class="center">
																<a href="#" class="btn btn-tbl-edit btn-xs">
														...
														<tr class="odd gradeX">
															...
															<td>
																<span
																	class="label label-sm box-shadow-1 label-danger">Leave
																</span>
															</td>
															<td class="center">
																<a href="#" class="btn btn-tbl-edit btn-xs">
										...
										<div class="m-b-20">
											<div class="doctor-profile">
												<div class="profile-header bg-b-purple">
													...
													<div class="name-center">435 Trips</div>
												</div>
										...
										<div class="m-b-20">
											<div class="doctor-profile">
												<div class="profile-header cyan-bgcolor">
													...
													<div class="name-center">876 Trips</div>
												</div>
										...
										<div class="m-b-20">
											<div class="doctor-profile">
												<div class="profile-header light-dark-bgcolor">
													...
													<div class="name-center">234 Trips</div>
												</div>
										...
										<div class="m-b-20">
											<div class="doctor-profile">
												<div class="profile-header bg-b-orange">
													<div class="user-name">Pooja Patel</div>
													<div class="name-center">23 Trips</div>
												</div>
										...
										<div class="m-b-20">
											<div class="doctor-profile">
												<div class="profile-header bg-b-green">
													<div class="user-name">Smita Patil</div>
													<div class="name-center">864 Trips</div>
												</div>
										...
										<div class="m-b-20">
											<div class="doctor-profile">
												<div class="profile-header bg-b-danger">
													<div class="user-name">John Smith</div>
													<div class="name-center">424 Trips</div>
												</div>
										...
										<div class="m-b-20">
											<div class="doctor-profile">
												<div class="profile-header bg-b-black">
													<div class="user-name">Pooja Patel</div>
													<div class="name-center">754 Trips</div>
												</div>
										...
										<div class="m-b-20">
											<div class="doctor-profile">
												<div class="profile-header bg-b-yellow">
													<div class="user-name">Smita Patil</div>
													<div class="name-center">842 Trips</div>
												</div>
										...
										<div class="m-b-20">
											<div class="doctor-profile">
												<div class="profile-header bg-b-pink">
													<div class="user-name">John Smith</div>
													<div class="name-center">123 Trips</div>
												</div>
