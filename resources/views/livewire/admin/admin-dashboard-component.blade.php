								...
								<div class="card-block">
									<div class="row text-center p-t-10">
										<div class="col-sm-4 col-6">
											<h4 class="margin-0 fw-bold">$ 209 </h4>
											<p class="text-muted"> Today's Income</p>
										</div>
										<div class="col-sm-4 col-6">
											<h4 class="margin-0 fw-bold">$ 837 </h4>
											<p class="text-muted">This Week's Income</p>
										</div>
										<div class="col-sm-4 col-6">
											<h4 class="margin-0 fw-bold">$ 3410 </h4>
							...
							<div class="card card-box">
								...
								<div class="card-body no-padding height-9">
									<div class="row text-center">
										...
										<div class="col-sm-3 col-6">
											<h4 class="margin-0 fw-bold">$ 78,000 </h4>
											...
											<table class="table display product-overview mb-30" id="support_table5">
												...
												<tbody>
													<tr>
														...
														<td>SUV</td>
														<td>
															<span class="label label-sm box-shadow-1 label-success">On
																Trip</span>
														</td>
														<td>123456789</td>
														<td>XN 01 1235</td>
													...
													<tr>
														...
														<td>
															<span
																class="label label-sm box-shadow-1 label-danger">leave</span>
														</td>
														<td>123456789</td>
														<td>GJ 98 3454</td>
														<td>
													...
													<tr>
														...
														<td>
															<span
																class="label label-sm box-shadow-1 label-warning ">Available</span>
														</td>
														<td>123456789</td>
														<td>PT 02 3534</td>
														<td>
										...
										<ul class="docListWindow small-slimscroll-style">
												...
												<div class="row">
													<div class="col-md-8 col-sm-8">
														<div class="prog-avatar">
															<img src="images/users/user1.jpg" alt="" width="40"
																height="40">
														</div>
														<div class="details">
															<div class="title">
											...
											<li>
												<div class="row">
													<div class="col-md-8 col-sm-8">
														<div class="prog-avatar">
															<img src="images/users/user2.jpg" alt="" width="40"
																height="40">
														</div>
														<div class="details">
															<div class="title">
											...
											<li>
												<div class="row">
													<div class="col-md-8 col-sm-8">
														<div class="prog-avatar">
															<img src="images/users/user3.jpg" alt="" width="40"
																height="40">
														</div>
														<div class="details">
															<div class="title">
											...
											<li>
												<div class="row">
													<div class="col-md-8 col-sm-8">
														<div class="prog-avatar">
															<img src="images/users/user4.jpg" alt="" width="40"
																height="40">
														</div>
														<div class="details">
															<div class="title">
